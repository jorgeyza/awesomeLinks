 ...
 * - last updated on 2021-12-19 with `next/image` 12.0.7 and `chakra-ui/react` 1.7.3
 *   - https://github.com/vercel/next.js/blob/v12.0.7/packages/next/client/image.tsx
 ...
 *   - https://github.com/vercel/next.js/compare/v11.1.2...canary
 *
...
import { forwardRef, SetStateAction, useImperativeHandle, useState, type Dispatch, type ReactElement } from 'react';
import {
  defaultLoader,
  useImageAttributes,
  useImageOnLoad,
...
type ImagePriorityProps = Pick<NextImageProps, 'priority'> & Pick<GenerateImageAttributesReturn, 'sizes' | 'src' | 'srcset'>;
...
ImageNative.displayName = 'ImageNative';
    ...
    <Head>
      <link
        ...
        {...{
          ...
          [process.env.__NEXT_REACT_ROOT ? 'imageSrcSet' : 'imagesrcset']: srcset,
          [process.env.__NEXT_REACT_ROOT ? 'imageSizes' : 'imagesizes']: sizes
        }}
  ...
  (
    ...
    return (
      <>
        ...
        <ImagePriority priority={priority} sizes={imgSizes} src={imgSrc} srcset={imgSrcSet} />
      </>
    );
  }
);
